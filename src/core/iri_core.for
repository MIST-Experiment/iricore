        ...
        contains
        subroutine iri_core(JF,JMAG,GLAT,GLON,IYYYY,MMDD,DHOUR,
     &    HEIBEG,HEIEND,HEISTP,OARR,datadir)
...
!         real, allocatable, dimension(:, :, :), intent(out) :: outf_out
          ...
          allocate(outf_out(20, 1000, SIZE(glat)))
          ...
          do i = 1, SIZE(glat), 1
          call IRI_SUB(JF,JMAG,GLAT(i),GLON(i),IYYYY,MMDD,DHOUR,
